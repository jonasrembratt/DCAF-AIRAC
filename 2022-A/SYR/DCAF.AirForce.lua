...
local function launchShell2()
   DCAF.Tanker:NewFromCallsign(CALLSIGN.Tanker.Shell, 2)
     ...
     :SetTrack(2, 201, NauticalMiles(40)) -- track begins at WP2, tracks heading 102 degrees for 40nm at block 22, and 'true' = track is drawn on F10 map
...
local function launchTexaco2()
   DCAF.Tanker:NewFromCallsign(CALLSIGN.Tanker.Texaco, 2)
      -- >>SHELL TRACK<< next line establishes the tanker track at waypoint 2, with 102 degree heading for 40nm (change as needed)
     :SetTrack(2, 21, NauticalMiles(40))  -- track begins at WP2, tracks heading 102 degrees for 40nm at block 22, and 'true' = track is drawn on F10 map
     :OnFuelState(0.17, function(tanker)  -- automatically RTB and spawn replacement when fuel reaches 17%
...
local function launchMagic2()
   DCAF.AWACS:NewFromCallsign(CALLSIGN.AWACS.Magic, 2)
      -- >>AWACS TRACK<< next line establishes the AWACS track at waypoint 2, 201 degree heading for 60nm (change as needed)
      :SetTrack(2, 201, NauticalMiles(60), nil, false) 
...
DCAF.Tanker:NewFromCallsign(CALLSIGN.Tanker.Shell, 1)
         -- >>SHELL TRACK<< next line establishes the tanker's track at waypoint 2, with 102 degree heading for 40nm (change as needed)
         :SetTrack(2, 201, NauticalMiles(40), nil, true) -- track begins at WP2, heading 201 degrees, for 40nm, at block 22, and 'true' = track is drawn on F10 map
...
DCAF.Tanker:NewFromCallsign(CALLSIGN.Tanker.Texaco, 1)
           -- >>SHELL TRACK<< next line establishes the tanker's track at waypoint 2, with 21 degree heading for 40nm (change as needed)
         :SetTrack(2, 21, NauticalMiles(40), nil, true) -- track begins at WP2, heading 21 degrees, for 40nm, at block 22, and 'true' = track is drawn on F10 map
...
DCAF.AWACS:NewFromCallsign(CALLSIGN.AWACS.Magic, 1)
         ...
         :SetTrack(1, 201, NauticalMiles(60), nil, true) 
